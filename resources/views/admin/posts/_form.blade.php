...
@php
    ...
    $isLegacyTemplate = $isEdit && $post->blade_file && !array_key_exists($post->blade_file, $backgroundTemplates);
@endphp
    ...
    <div class="col-12 col-xl-4">
        <div class="sidebar-sticky">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body py-3">
                    @if($isLegacyTemplate)
                        {{-- Legacy static-blade posts: preserve blade_file, don't show color picker --}}
                        <input type="hidden" name="blade_file" value="{{ $post->blade_file }}">
                        <p class="small text-muted mb-0">
                            <i class="bi bi-file-earmark-code me-1"></i>
                            Static template: <code>{{ $post->blade_file }}</code>
                        </p>
                        <p class="small text-muted mb-0 mt-1">Background color only applies to posts with editor content.</p>
                    @else
