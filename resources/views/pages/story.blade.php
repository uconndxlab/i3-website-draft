    ...
    <div class="timeline-navigation mb-4 mt-xl-5" style="z-index: 1000; max-width:450px; margin:0 auto; position: relative;">
        <div class="d-flex align-items-center justify-content-center rounded-pill px-4 py-3">
            ...
            <button id="timeline-play-pause" class="btn btn-sm btn-outline-light me-3 rounded-circle"
                ...
                aria-label="Pause or resume timeline auto-advance">
            ...
            <div class="timeline-line position-relative d-flex align-items-center justify-content-center">
                ...
                <button class="year-marker position-absolute btn p-0 border-0 bg-transparent" data-year="2017"
                    ...
                    <span class="year-label position-absolute text-light small"
                        style="top: 20px; left: 50%; transform: translateX(-50%); white-space: nowrap;">2017</span>
                </button>
                ...
                <button class="year-marker position-absolute btn p-0 border-0 bg-transparent" data-year="2019"
                    ...
                    <div class="marker-dot bg-light rounded-circle"
                        style="width: 12px; height: 12px; cursor: pointer; transition: all 0.3s ease;"></div>
                    <span class="year-label position-absolute text-light small"
                        style="top: 20px; left: 50%; transform: translateX(-50%); white-space: nowrap;">2019</span>
                </button>
                ...
                <button class="year-marker position-absolute btn p-0 border-0 bg-transparent" data-year="2020"
                    ...
                    <div class="marker-dot bg-light rounded-circle"
                        style="width: 12px; height: 12px; cursor: pointer; transition: all 0.3s ease;"></div>
                    <span class="year-label position-absolute text-light small"
                        style="top: 20px; left: 50%; transform: translateX(-50%); white-space: nowrap;">2020</span>
                </button>
                ...
                <button class="year-marker position-absolute btn p-0 border-0 bg-transparent" data-year="2024"
                    ...
                    <div class="marker-dot bg-light rounded-circle"
                        style="width: 12px; height: 12px; cursor: pointer; transition: all 0.3s ease;"></div>
                    <span class="year-label position-absolute text-light small"
                        style="top: 20px; left: 50%; transform: translateX(-50%); white-space: nowrap;">2024</span>
                </button>
                ...
                <button class="year-marker position-absolute btn p-0 border-0 bg-transparent" data-year="2025"
                    ...
                    <div class="marker-dot bg-light rounded-circle"
                        style="width: 12px; height: 12px; cursor: pointer; transition: all 0.3s ease;"></div>
                    <span class="year-label position-absolute text-light small"
                        style="top: 20px; left: 50%; transform: translateX(-50%); white-space: nowrap;">2025</span>
                </button>
            </div>
        </div>
    </div>
        ...
        <div class="container position-relative my-5">
            ...
            <div class="row slide active" id="slide-2017" data-bg-color="#111111">
                <div class="col-md-6 text-center d-flex align-items-center timeline-header">
                    <h2 data-odometer-initial="2025" data-odometer-final="2017" data-aos="odometer"
                        class="text-light odometer">2017</h2>
                </div>
                <div class="col-md-6 d-flex flex-column justify-content-center timeline-content">
                    <h3 style="font-family: area-normal,sans-serif; font-size: 40px;" class="fw-bold text-white mb-2 mt-3">
                        Our Origins</h3>
                    <hr
            ...
            <div class="row slide" id="slide-2019" data-bg-color="#911616">
                <div class="col-md-6 text-center d-flex align-items-center timeline-header">
                    <h2 data-odometer-initial="2017" data-odometer-final="2019" data-aos="odometer"
                        class="text-light odometer">2019</h2>
                </div>
                <div class="col-md-6 d-flex flex-column justify-content-center timeline-content">
                    <div class="mb-3">
                    ...
                    <h3 style="font-family: area-normal,sans-serif; font-size: 40px;"
                        class="fw-bold text-white mb-2 mt-3">Born in the DX Lab</h3>
                    <hr
                        style="width: 60px; height: 2px; margin: 1rem 0; border-color: #FFBB4D; background-color: #FFBB4D;opacity: 1;">
            ...
            <div class="row slide" id="slide-2020" data-bg-color="#111111">
                <div class="col-md-6 text-center d-flex align-items-center timeline-header">
                    <h2 class="text-light odometer" data-odometer-initial="2019" data-odometer-final="2020"
                        data-aos="odometer">2020</h2>
                </div>
                <div class="col-md-6 d-flex flex-column justify-content-center timeline-content">
                    <div class="mb-3">
                    ...
                    <h3 style="font-family: area-normal,sans-serif; font-size: 40px;"
                        class="fw-bold text-white mb-2 mt-3">The DX Group Emerges...</h3>
                    <hr
                        style="width: 60px; height: 2px; margin: 1rem 0; border-color: #4DB3FF; background-color: #4DB3FF;opacity: 1;">
            ...
            <div class="row slide" id="slide-2024" data-bg-color="var(--deep)">
                <div class="col-md-6 text-center d-flex align-items-center timeline-header">
                    <h2 class="text-light odometer" data-odometer-initial="2020" data-odometer-final="2024"
                        data-aos="odometer">2024</h2>
                </div>
                <div class="col-md-6 d-flex flex-column timeline-content">
                    ...
                    <h3 style="font-family: area-normal,sans-serif; font-size: 40px;"
                        class="fw-bold text-white mb-2 mt-3">i3 is Born</h3>
                    <hr
                        style="width: 60px; height: 2px; margin: 1rem 0; border-color: #4DB3FF; background-color: #4DB3FF;opacity: 1;">
                    ...
                    <div class="mb-3">
                        <a title="Next: 2025" href="#slide-2025" class="btn btn-outline-light p-1"
                            style="border-radius:50%; width:32px; height:32px; display:inline-flex; align-items:center; justify-content:center; color: #4DB3FF; background-color: #FFFFFF1A; border: none;">
                            <i class="bi bi-arrow-down" style="font-size:1rem;"></i>
                        </a>
                    </div>
            ...
            <div class="row slide" id="slide-2025" data-bg-color="#000000">
                <div class="col-md-6 text-center d-flex align-items-center timeline-header">
                    <h2 class="text-light odometer" data-odometer-initial="2024" data-odometer-final="2025"
                        data-aos="odometer">2025</h2>
                </div>
                <div class="col-md-6 d-flex flex-column timeline-content">
                    <div class="mb-3">
                        <a title="Previous: 2024" href="#slide-2024" class="btn btn-outline-light p-1"
                            style="border-radius:50%; width:32px; height:32px; display:inline-flex; align-items:center; justify-content:center; color: #4DB3FF; background-color: #FFFFFF1A; border: none;">
                            <i class="bi bi-arrow-up" style="font-size:1rem;"></i>
                        </a>
                    </div>
                    ...
                    <h3 style="font-family: area-normal,sans-serif; font-size: 40px;"
                        class="fw-bold text-white mb-2 mt-3">A Strategic Merger</h3>
                    <hr
                        style="width: 60px; height: 2px; margin: 1rem 0; border-color: #4DB3FF; background-color: #4DB3FF;opacity: 1;">

                    <p class="text-light">
                        <img style="max-width:80px; float:left; margin-right: 12px;"
                            src="{{ asset('img/i3/gs-knockout.png') }}">
                        i3 merges with Greenhouse Studios, an interdisciplinary unit driving innovative and collaborative
                        scholarly practice. By introducing the competencies of the Greenhouse Studios team, i3 now expands
                        its mission to include the integration of design thinking and human-centric approaches to
                        innovations across and beyond the university.
                    </p>
                    <div class="d-flex w-100 justify-content-start align-items-center">
                    <div class="btn display-btn btn-arrow-slide">
                        <a href="{{ route('merger') }}" class="btn-arrow-slide-cont btn-arrow-slide-cont--white">
                            <span class="btn-arrow-slide-circle" aria-hidden="true">
                                <span class="btn-arrow-slide-arrow btn-arrow-slide-icon"></span>
                            </span>
                            <span class="btn-arrow-slide-text"> About the Merger </span>
                        </a>
                    </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-md-6">
                    ...
                    <p class="text-dark">That's the goal. There's no single path to get there, but here's how we like to
                        work:</p>
                    <h3 class="text-dark">Start small. Learn fast. Build what matters.</h3>
                    <p class="text-dark">
                        We usually begin with something simple—a rough draft, a working prototype, a first version you can
                        click.
                        Then we test, refine, and build from there. It's not about cutting corners. It's about getting
                        feedback sooner,
                        staying flexible, and keeping the momentum.
                    </p>
                    <p class="text-dark">
                        You'll see results early.
                        We know every project is different, and we don't pretend this approach is perfect. But it's how we
                        think
                ...
                <div class="col-md-6 text-center">
                    <div data-aos="fade-left" data-aos-duration="1200">
                        <svg viewBox="0 0 800 200" class="w-100" id="processSvg" style="overflow:visible"
                            ...
                            <!-- Timeline Line -->
                            <line x1="100" y1="80" x2="700" y2="80" stroke="#333"
                                stroke-width="3" class="svg-element" />

                            <!-- Station Dots -->
                            <circle cx="100" cy="80" r="8" fill="#4DB3FF" stroke="#333" stroke-width="2"
                                class="svg-element station-dot" />
                            <circle cx="300" cy="80" r="8" fill="#4DB3FF" stroke="#333" stroke-width="2"
                                class="svg-element station-dot" />
                            <circle cx="500" cy="80" r="8" fill="#4DB3FF" stroke="#333" stroke-width="2"
                                class="svg-element station-dot" />
                            <circle cx="700" cy="80" r="8" fill="#4DB3FF" stroke="#333" stroke-width="2"
                                class="svg-element station-dot" />

                            <!-- Define Badge -->
                            <g class="svg-element" transform="translate(100,80)">
                                <text x="0" y="38" text-anchor="middle" font-family="area-normal" fill="#000"
                                    font-weight="bold" font-size="16">Define</text>
                            </g>

                            <!-- Build Badge -->
                            <g class="svg-element" transform="translate(300,80)">
                                <text x="0" y="38" text-anchor="middle" font-family="area-normal" fill="#000"
                                    font-weight="bold" font-size="16">Build</text>
                            </g>

                            <!-- Refine Badge -->
                            <g class="svg-element" transform="translate(500,80)">
                                <text x="0" y="38" text-anchor="middle" font-family="area-normal" fill="#000"
                                    font-weight="bold" font-size="16">Refine</text>
                            </g>

                            <!-- Repeat Badge -->
                            <g class="svg-element" transform="translate(700,80)">
                                <text x="0" y="38" text-anchor="middle" font-family="area-normal" fill="#000"
                                    font-weight="bold" font-size="16">Repeat</text>
                            </g>
                            ...
                            <g id="huskyCharacter" transform="translate(100,80)"
                                ...
                                <g id="huskyRotation">
                                    ...
                                    <image href="{{ asset('img/i3/1959-uconn-husky.png') }}" x="-25" y="-75"
                                        width="50" height="50" preserveAspectRatio="xMidYMid meet"
        ...
        <div class="container">
            ...
            <div class="row g-4" data-aos="fade-up" data-aos-duration="1200">
                ...
                @php
                    $stories = [
                        [
                            'title' => 'UConn Funds Five COVID-19 Research Projects, Announces Additional Funding',
                            'publication' => 'UConn Today',
                            'date' => '10/02/2020',
                            'link' =>
                                'https://today.uconn.edu/2020/10/uconn-funds-five-covid-19-research-projects-announces-additional-funding/',
                            'img' =>
                                'https://today.uconn.edu/wp-content/uploads/2020/05/GettyImages-1220459949-e1615807575563.jpg',
                        ],
                        [
                            'title' =>
                            ...
                            'date' => '06/23/2025',
                            'link' =>
                                'https://today.uconn.edu/2025/06/scorecard-for-safer-play-athletic-field-assessment-form-updated-for-mobile-use/',
                            'img' =>
                                'https://today.uconn.edu/wp-content/uploads/2025/06/Drag-mat-cultivation-by-Alyssa-Siegel-Miles-1024x683.jpg',
                        ],
                        [
                            'title' =>
                            ...
                            'date' => '04/19/2024',
                            'link' =>
                                'https://today.uconn.edu/2024/04/new-uconn-extension-publication-website-shares-answers-connecticut-residents-can-trust/',
                            'img' =>
                                'https://today.uconn.edu/wp-content/uploads/2023/04/DJI_0622-HDR-Edit-Crop-1024x683.jpg',
                        ],
                        [
                            'title' => 'New Game Makes Financial Education Fun',
                            'publication' => 'UConn Today',
                            'date' => '04/26/2023',
                            'link' => 'https://today.uconn.edu/2023/04/new-game-makes-financial-education-fun/',
                            'img' => 'https://today.uconn.edu/wp-content/uploads/2023/03/law170419a219-1024x683.jpg',
                        ],
                        [
                            'title' =>
                            ...
                            'date' => '04/20/2020',
                            'link' =>
                                'https://dailycampus.com/2020/04/20/2020-4-20-research-spotlight-pushing-the-boundaries-of-digital-media-with-uconns-dx-lab/',
                            'img' =>
                        ...
                        [
                            ...
                            'date' => '05/25/2021',
                            'link' => 'https://link.springer.com/article/10.1007/s10389-021-01570-6',
                            'img' =>
                                App\Models\WorkItem::where('title', 'WellSCAN')->first()->best_thumbnail_url ??
                                asset('img/i3/work/wellscan.png'),
                        ],
                        [
                            'title' => 'Strengthening Connecticut Farms with Risk Management Training and Tools',
                            'publication' => 'UConn Today',
                            'date' => '04/01/2025',
                            'link' =>
                                'https://today.uconn.edu/2025/04/strengthening-connecticut-farms-with-risk-management-training-and-tools/',
                            'img' =>
                                'https://today.uconn.edu/wp-content/uploads/2020/11/Farm160719c092-e1697619059398.jpg',
                        ],
                        [
                            'title' => 'Website Breaks Down Statewide Benefit of UConn Research Funding',
                            'publication' => 'UConn Today',
                            'date' => '10/02/2017',
                            'link' =>
                                'https://today.uconn.edu/2017/10/website-breaks-statewide-benefit-uconn-research-funding/',
                            'img' => 'https://today.uconn.edu/wp-content/uploads/2017/09/CTMapGrantExpenditures.jpg',
                        ],
                        [
                            'title' =>
                            ...
                            'date' => '02/15/2022',
                            'link' =>
                                'https://today.uconn.edu/2022/02/app-supporting-archival-research-continue-development-with-community-partnerships/',
                            'img' =>
                                App\Models\WorkItem::where('title', 'Sourcery')->first()->best_thumbnail_url ??
                                asset('img/i3/work/sourcery.png'),
                        ],
                    ];
                ...
                @foreach ($stories as $story)
                    <div class="col-12 col-sm-6 col-lg-4">
                        <div class="position-relative" style="padding-top: 62.5%;">
                            <div
                                class="card news-card text-white border-0 shadow-sm overflow-hidden rounded-4 position-absolute top-0 start-0 w-100 h-100 ">
                                ...
                                <a href="{{ $story['link'] }}" target="_blank" class="stretched-link focus-ring"
                                    aria-label="Read more about {{ $story['title'] }}"></a>
                            </div>
                        </div>
                    </div>
                @endforeach
