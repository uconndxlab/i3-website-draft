...
@section('meta_description', 'A Scholarly Research Aggregator - Lincus provides a centralized platform for discovering
faculty expertise and research at UConn.')
...
<canvas class="dot-animation" id="dot-canvas-left" width="600" height="600"
  style="position: absolute; left: 0; top: 0; z-index: -1000;"></canvas>
<canvas class="dot-animation" id="dot-canvas-right" width="600" height="600"
  style="position: absolute; right: 0; top: 0; z-index: -1000"></canvas>
...
<div class="lincus-page">
  ...
  <section>
    <div class="container hero d-flex flex-column justify-content-center align-items-center position-relative">
      ...
      <span class="inter-reg bg-white text-slate-grey fs-6 mt-2 py-1 px-4 hero-published text-center"
        style="border:1px solid #CED0D6">CASE STUDY PUBLISHED 03/20/2026</span>
    </div>
  </section>
    ...
    <div class="container overview position-relative">
      ...
      <div class="row gx-2 pb-2 justify-content-between">
        <div class="col-lg-4 col-md-6 mb-1 mb-lg-0 mx-auto mt-1" data-aos="fade-up" data-aos-delay="100">
          <div
            class="col-12 d-flex stat-wrap radius contributions align-items-center justify-content-between ps-2 pe-2 py-2">
        ...
        <div class="col-lg-4 col-md-6 mx-auto mt-1" data-aos="fade-up" data-aos-delay="600">
          <div class="col-12 d-flex stat-wrap radius grants align-items-center justify-content-between px-2 h-100">
            <div class="stat d-flex flex-column ms-3">
              <div class="grants-odometer odometer-auto-theme"
                style="font-size: 30px; font-weight: bold; display: inline-block;">0</div>
              <span class="fs-6 lust-light stat-label">Grants</span>
            </div>
            <!-- File icon -->
            <svg width="174" height="157" viewBox="0 0 174 157" fill="none" class="icon align-self-end"
              xmlns="http://www.w3.org/2000/svg">
              <g id="face">
                ...
                <path id="smile-left" d="M45 25C45 25 53.5 32 75.5 32" stroke="#F8B81D" stroke-width="4"
                  stroke-linecap="round" />
                <path id="smile-right" d="M101 25C101 25 94 32 72 32" stroke="#F8B81D" stroke-width="4"
                  stroke-linecap="round" />
              </g>
              <g id="file-lines">
                <path id="Vector 7" d="M13.5 43.5H131" stroke="#F8B81D" stroke-opacity="0.4" stroke-width="2"
                  stroke-linecap="round" />
                <path id="Vector 9" d="M13.5 54H125" stroke="#F8B81D" stroke-opacity="0.4" stroke-width="2"
                  stroke-linecap="round" />
                <path id="Vector 11" d="M13.5 64H128.5" stroke="#F8B81D" stroke-opacity="0.4" stroke-width="2"
                  stroke-linecap="round" />
                <path id="Vector 13" d="M13.5 74H131" stroke="#F8B81D" stroke-opacity="0.4" stroke-width="2"
                  stroke-linecap="round" />
                <path id="Vector 15" d="M13.5 84H124.5" stroke="#F8B81D" stroke-opacity="0.4" stroke-width="2"
                  stroke-linecap="round" />
                <path id="Vector 17" d="M13.5 94H125" stroke="#F8B81D" stroke-opacity="0.4" stroke-width="2"
                  stroke-linecap="round" />
                <path id="Vector 19" d="M13.5 104H128" stroke="#F8B81D" stroke-opacity="0.4" stroke-width="2"
                  stroke-linecap="round" />
                <path id="Vector 21" d="M13.5 114H128" stroke="#F8B81D" stroke-opacity="0.4" stroke-width="2"
                  stroke-linecap="round" />
                <path id="Vector 23" d="M13.5 124H126.5" stroke="#F8B81D" stroke-opacity="0.4" stroke-width="2"
                  stroke-linecap="round" />
                <path id="Vector 25" d="M13.5 134H131" stroke="#F8B81D" stroke-opacity="0.4" stroke-width="2"
                  stroke-linecap="round" />
                <path id="Vector 27" d="M13.5 144H126" stroke="#F8B81D" stroke-opacity="0.4" stroke-width="2"
                  stroke-linecap="round" />
                <path id="Vector 29" d="M13.5 154H131" stroke="#F8B81D" stroke-opacity="0.4" stroke-width="2"
                  stroke-linecap="round" />
              </g>
              <g id="badge">
                <path id="badge-sash" d="M132 108V139L143.5 130.512L155 139V109.107" stroke="#F8B81D"
                  stroke-width="5" />
                <path id="badge-emblem"
                  d="M145 118.25L136.625 110H125V98.375L116.75 90L125 81.625V70H136.625L145 61.75L153.375 70H165V81.625L173.25 90L165 98.375V110H153.375L145 118.25ZM145 111.25L151.25 105H160V96.25L166.25 90L160 83.75V75H151.25L145 68.75L138.75 75H130V83.75L123.75 90L130 96.25V105H138.75L145 111.25Z"
                  fill="#F8B81D" />
                <path id="badge-star"
                  d="M145 96.1875L137.688 100.625L139.625 92.3125L133.125 86.6875L141.688 86L145 78.125L148.312 86L156.875 86.6875L150.375 92.3125L152.312 100.625L145 96.1875Z"
                  fill="#F8B81D" />
              </g>
              <path id="file-bg" d="M0 5C0 2.23857 2.23858 0 5 0H140C142.761 0 145 2.23858 145 5V157H0V5Z"
                fill="#F8B81D" fill-opacity="0.1" />
    ...
    <div class="container mt-5">
      ...
      <div class="row">
        <p class="w-100 fs-5 inter-light mb-2">The concept behind <a target="_blank"
          ...
          property has since returned to the UConn, where the platform has been redeveloped and is now maintained by the
          Institutional Insights & Innovation (i3) team.
        </p>

        <p class="w-100 fs-5 inter-light mb-0">Years later, recognizing the continued need for a modern research
      ...
      <div class="row circles-row" data-aos="fade-in" data-aos-delay="800" data-aos-once="true">
        <svg width="100%" height="100%" viewBox="-40 0 1500 450" fill="none" xmlns="http://www.w3.org/2000/svg"
          id="circles-svg" style="overflow: visible;">
          <!-- Left cluster -->
          ...
          <g id="circle-text-1">
            ...
            <text id="Lorem Ipsum_9" fill="#707070" style="white-space: pre" xml:space="preserve" font-family="Inter"
              font-size="20" font-weight="300" letter-spacing="0em">
              <tspan x="0" y="132.773">Faculty G</tspan>
            </text>
          </g>
          <g id="circle-text-2">
            <circle id="circle-2" cx="202.5" cy="223.5" r="23.5" fill="#5439CD" />
            <text id="Lorem Ipsum_8" fill="#707070" style="white-space: pre" xml:space="preserve" font-family="Inter"
              font-size="20" font-weight="300" letter-spacing="0em">
              <tspan x="142" y="271.773">Faculty H</tspan>
            </text>
          </g>
          <g id="circle-text-3">
            <circle id="circle-3" cx="221.5" cy="35.5" r="23.5" fill="#7A3389" />
            <text id="Lorem Ipsum_3" fill="#707070" style="white-space: pre" xml:space="preserve" font-family="Inter"
              font-size="20" font-weight="300" letter-spacing="0em">
              <tspan x="161" y="84.7727">Faculty I</tspan>
            </text>
          </g>
          <g id="circle-text-4">
            <circle id="circle-4" cx="375" cy="165" r="32" fill="#426902" />
            <text id="Lorem Ipsum_2" fill="#707070" style="white-space: pre" xml:space="preserve" font-family="Inter"
              font-size="20" font-weight="300" letter-spacing="0em">
              <tspan x="314" y="224.773">Faculty F</tspan>
            </text>
          </g>
          <g id="circle-text-5">
            <circle id="circle-5" cx="576.5" cy="101.5" r="82.5" fill="#50558C" />
            <text id="Lorem Ipsum" fill="#707070" style="white-space: pre" xml:space="preserve" font-family="Inter"
              font-size="20" font-weight="300" letter-spacing="0em">
              <tspan x="516" y="214.773">Faculty A</tspan>
            </text>
          </g>

          <g id="circle-text-6">
            <circle id="circle-6" cx="799" cy="106" r="59" fill="#A10F0F" />
            <text id="Lorem Ipsum_4" fill="#707070" style="white-space: pre" xml:space="preserve" font-family="Inter"
              font-size="20" font-weight="300" letter-spacing="0em">
              <tspan x="739" y="188.773">Faculty B</tspan>
            </text>
          </g>
          <g id="circle-text-7">
            <circle id="circle-7" cx="893" cy="277" r="37" fill="#86B9FF" />
            <text id="Lorem Ipsum_5" fill="#707070" style="white-space: pre" xml:space="preserve" font-family="Inter"
              font-size="20" font-weight="300" letter-spacing="0em">
              <tspan x="832" y="342.773">Faculty C</tspan>
            </text>
          </g>
          <g id="circle-text-8">
            <circle id="circle-8" cx="964.5" cy="23.5" r="23.5" fill="#D16DD7" />
            <text id="Lorem Ipsum_6" fill="#707070" style="white-space: pre" xml:space="preserve" font-family="Inter"
              font-size="20" font-weight="300" letter-spacing="0em">
              <tspan x="904" y="72.7727">Faculty D</tspan>
            </text>
          </g>
          <g id="circle-text-9">
            <circle id="circle-9" cx="1088.5" cy="183.5" r="15.5" fill="#F38415" />
            <text id="Lorem Ipsum_7" fill="#707070" style="white-space: pre" xml:space="preserve" font-family="Inter"
              font-size="20" font-weight="300" letter-spacing="0em">
              <tspan x="1028" y="222.773">Faculty E</tspan>
            </text>
          </g>
        </svg>
      </div>
  ...
  <section id="process">
    <div class="container process mt-3">
      ...
      <div class="row">
        <span class="inter-light fs-3 mb-3">Start small. Learn fast. <span class="inter-med">Build what
            matters.</span></span>
        <p class="w-100 fs-5 inter-light">
          ...
          version you can click. From there we work closely with stakeholders to test ideas, gather feedback, and refine
          the system together. Because the work happens inside the University, we can respond quickly and shape the
          platform around the needs of the community rather than the constraints of a vendor product. The result is a
          solution that reflects how UConn actually works and evolves alongside it. Every project is different, but this
          approach helps us turn institutional challenges into tools that the University truly owns and can continue to
          improve over time.
        </p>
      </div>
          ...
          <div class="process-card-inner h-100 d-flex flex-column">
            <div class="process-card-front bg-off-white radius d-flex flex-column p-4">
              ...
              <div class="process-content mt-auto">
                ...
                <span class="z-2 inter-light fs-5 text-start mb-0">Discover what matters. Understand users, challenges,
            ...
            <div class="process-card-back bg-white radius d-flex flex-column justify-content-end p-4">
              ...
              <span class="z-2 inter-light text-start mb-0">We begin by meeting with stakeholders and mapping the
                problem together. For Lincus, this meant understanding how faculty expertise is described across
                University systems and how people actually search for collaborators and research topics.</span>
            </div>
          </div>
        </div>
          ...
          <div class="process-card-inner h-100 d-flex flex-column">
            <div class="process-card-front bg-off-white radius d-flex flex-column p-4">
              ...
              <div class="process-content mt-auto">
                ...
                <span class="z-2 inter-light fs-5 text-start mb-0">Make it tangible. Turn ideas into something you can
            ...
            <div class="process-card-back bg-white radius d-flex flex-column justify-content-end p-4">
              ...
              <span class="z-2 inter-light text-start mb-0">We quickly built an early version of the platform so
                stakeholders could see how faculty profiles, publications, and connections might come together. A
                prototype helps everyone react to something concrete rather than abstract ideas.</span>
            </div>
          </div>
        </div>
          ...
          <div class="process-card-inner h-100 d-flex flex-column">
            <div class="process-card-front bg-off-white radius d-flex flex-column p-4">
              ...
              <div class="process-content mt-auto">
                ...
                <span class="z-2 inter-light fs-5 text-start mb-0">Try, learn, refine. Gather feedback early, spot
            ...
            <div class="process-card-back bg-white radius d-flex flex-column justify-content-end p-4">
              ...
              <span class="z-2 inter-light text-start mb-0">As stakeholders and early users explored the system, their
                feedback shaped how Lincus evolved. Search behavior, profile information, and collaboration signals were
                refined through real use.</span>
            </div>
          </div>
        </div>
          ...
          <div class="process-card-inner h-100 d-flex flex-column">
            <div class="process-card-front bg-off-white radius d-flex flex-column p-4">
              ...
              <div class="process-content mt-auto">
                ...
                <span class="z-2 inter-light fs-5 text-start mb-0">Launch with confidence. Deliver a working solution
            ...
            <div class="process-card-back bg-white radius d-flex flex-column justify-content-end p-4">
              ...
              <span class="z-2 inter-light text-start mb-0">Once the platform was ready, Lincus was launched to the
                community. From there, real usage continues to guide improvements so the system grows alongside the
                University's research ecosystem.</span>
            </div>
          </div>
        </div>
      </div>
  ...
  <section id="challenge">
    <div class="container-fluid mt-5 bg-midnight py-5 rounded-top-4">
      <div class="container challenge text-white my-4 pb-5">
        ...
        <p class="fs-5 inter-light mb-0">These shortcomings limited Lincus's usefulness for students, faculty, and
          external users alike. Without a reliable, centralized way to explore research expertise, the University lacked
          a scalable solution for surfacing the work happening across departments and disciplines. Recognizing this
          need, i3 identified Lincus as a high-impact opportunity to improve research visibility and knowledge discovery
          across UConn. They aimed to rebuild Lincus to match new development standards, take advantage of new data
          sources, and align it to University sustainability goals.
        </p>
      </div>
    </div>
      ...
      <div class="container vision text-black mt-4 mb-0 mb-xxl-4">
        ...
        <div class="row">
          <span class="inter-light fs-3 mb-3">A <span class="inter-med">centralized</span>, living source of academic
            expertise.</span>
          <p class="w-100 fs-5 inter-light">
            Under i3's leadership, the new version of Lincus was designed to be both technically sustainable and
            institutionally integrated. This approach aligns with i3's broader mission: building internal tools that
            reduce duplication, improve data quality, and make institutional knowledge more accessible. Lincus not only
            serves students and external audiences searching for experts—it also provides a clear incentive for faculty
            to keep their Interfolio records accurate, knowing that this information feeds directly into a public-facing
            platform.
          </p>
        </div>
...
">
          <div class="vision-img-wrap mt-xl-5 mx-auto me-xl-0 order-2 order-xl-1">
            <img src="/lincus-assets/assets/lincus-mockup.png" alt="Lincus Profile" class="vision-img"
            ...
            <div class="row justify-content-center justify-content-xl-start">
              ...
              <div class="col-12 col-md-11 col-xl-4 ps-2 my-2 my-xl-0">
                <div class="vision-card-wrap h-100 position-relative" data-aos="fade-up" data-aos-delay="50">
                  <svg width="765" height="131" viewBox="0 0 765 131" fill="none" xmlns="http://www.w3.org/2000/svg"
                    class="vision-dash dash-1 d-none d-xl-block">
                    <path d="M1.83829 0.787842C39.3383 88.2878 263.838 206.788 763.838 56.7878"
                      stroke="url(#paint0_linear_66_499)" stroke-width="2" stroke-dasharray="8 8" class="dash" />
                    <path d="M1.83829 0.787842C39.3383 88.2878 263.838 206.788 763.838 56.7878" stroke="#F8B81D"
                      stroke-width="4" class="cover" />
                    <defs>
                      <linearGradient id="paint0_linear_66_499" x1="1.83829" y1="38.2878" x2="698.838" y2="38.2878"
                  ...
                  <div class="col-12 vision-card position-relative radius overflow-visible d-flex p-3 flex-column">
                    ...
                    <p class="inter-light fs-6 mb-3">
                      Primary source for faculty profiles. Manages academic and professional details, ensuring your core
              ...
              <div class="col-12 col-md-11 col-xl-4 ps-2 mb-2 mb-xl-0">
                <div class="vision-card-wrap h-100 position-relative" data-aos="fade-up" data-aos-delay="150">
                  <svg width="479" height="99" viewBox="0 0 479 99" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path d="M1.94597 0.46167C22.946 88.9617 222.446 119.462 477.946 79.4617"
                      stroke="url(#paint0_linear_66_503)" stroke-width="2" stroke-dasharray="8 8" class="dash" />
                    <path d="M1.94597 0.46167C22.946 88.9617 222.446 119.462 477.946 79.4617" stroke="#F8B81D"
                      stroke-width="4" class="cover" />
                    <defs>
                      <linearGradient id="paint0_linear_66_503" x1="1.94597" y1="64.2117" x2="156.446" y2="64.2117"
                        gradientUnits="userSpaceOnUse">
                        <stop stop-color="white" />
                  ...
                  <div class="col-12 vision-card position-relative radius overflow-visible d-flex p-3 flex-column">
                    ...
                    <p class="inter-light fs-6 mb-3">
                      Provides publications and co-author connections. Automatically enriches profiles with verified
                      research outputs.
                    </p>
                  </div>
                </div>
              ...
              <div class="col-12 col-md-11 col-xl-4 mb-4 mb-xl-0 ps-2">
                <div class="vision-card-wrap h-100 position-relative" data-aos="fade-up" data-aos-delay="250">
                  <svg width="311" height="77" viewBox="0 0 311 77" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path d="M2 0C2 51 116.5 102.5 310.5 57.5" stroke="url(#paint0_linear_66_506)" stroke-width="2"
                      stroke-dasharray="8 8" class="dash" />
                    <path d="M2 0C2 51 116.5 102.5 310.5 57.5" stroke="#F8B81D" stroke-width="4" class="cover" />
                    <defs>
                      <linearGradient id="paint0_linear_66_506" x1="-14.5" y1="16" x2="80.5" y2="94"
                        gradientUnits="userSpaceOnUse">
                        <stop stop-color="white" />
                  ...
                  <div class="col-12 vision-card position-relative radius overflow-visible d-flex p-3 flex-column">
                    ...
                    <p class="inter-light fs-6 mb-3">
                      Allows adjustments and additions not captured elsewhere. Add Scopus IDs, correct details, and
                      ensure your profile fully reflects your work.
                    </p>
                  </div>
                </div>
              </div>
    ...
    <div class="container-fluid build-wrap text-white bg-midnight pt-5 rounded-bottom-4 position-relative">
      <div class="container build-head my-4 pt-4 ">
        ...
        <p class="fs-5 inter-light mb-0">
          As the sole developer on the project, Maggie worked closely within the i3 ecosystem to translate this vision
          into a functional system. Over the course of a year, she designed the database architecture, built complex
          data relationships, and managed the integration of more than 120,000 research contributions including
      ...
      <div class="row build-row-1">
        <div class="col-lg-6 ps-0">
          <img class="img-fluid w-100" src="/lincus-assets/assets/lincus-action.png"
            alt="Laptop on table with lincus open">
        </div>
        <div class="col-lg-6 d-flex align-items-center justify-content-center">
          <div class="container mt-lg-0 mt-5 mb-lg-5">
            <p class="fs-5 inter-light mb-0">
              Lincus was built using the <a class="" href="https://laravel.com/" target="_blank"><span
                  class="inter-med yellow-shadow">Laravel Framework</span></a>, which has become a core part of i3's
              development approach. Laravel allows the team to move quickly from concept to working software while
              maintaining a clean, maintainable codebase. Its strong conventions and approachable learning curve make it
              well suited to a university environment where students and new developers can quickly contribute to real
              projects.
      ...
      <div class="container build-row-2">
        <div class="row">
          ...
          <div class="col-lg-7">
            <div
              class="mac-header bg-white justify-content-start align-items-center gap-2 d-flex ps-3 py-2 rounded-top-3">
            ...
            <div class="mac-editor text-light-grey fs-6 py-4 px-3 d-flex flex-column gap-5 pb-4 pb-lg-0">
              <div class="line-group d-flex flex-column align-items-start">
                ...
                <span class="editor-line tab-0"><span style="color: #84D3EC">public function</span> show(Request <span
                    style="color: #FF6179">$request</span>, <span style="color: #FF6179">$slug</span>, <span
                    style="color: #FF6179">$tab</span> = <span style="color: #C9E590">'show'</span>){</span>
                <span class="editor-line tab-1"><span style="color: #FF6179">$person</span> = <span
                    style="color: #FF6179">$this</span>->loadPersonAndRelationships(<span
                    style="color: #FF6179">$slug</span>);</span>
                <span class="editor-line tab-1"><span style="color: #FF6179">$user</span> = <span
                    style="color: #FF6179">$person</span>->user;</span>
                <span class="editor-line tab-1"><span style="color: #FF6179">$coauthors</span> = <span
                    style="color: #FF6179">$this</span>->getCoauthorsData(<span
                    style="color: #FF6179">$person</span>);</span>
                <span class="editor-line tab-1"><span style="color: #FF6179">$scopusMap</span> = <span
                    style="color: #FF6179">$this</span>->getScopusMap(<span
                    style="color: #FF6179">$person</span>);</span>
                <span class="editor-line tab-1" style="color: #aaaaaa">// Grant sorting logic, default is year
                  descending</span>
                <span class="editor-line tab-1"><span style="color: #FF6179">$grantSort</span> = <span
                    style="color: #FF6179">$request</span>->input(<span style="color: #C9E590">'grantSort'</span>, <span
                    style="color: #C9E590">'year_desc'</span>);</span>
                <span class="editor-line tab-1"><span style="color: #FF6179">$grants</span> = <span
                    style="color: #FF6179">$this</span>->sortGrants(<span style="color: #FF6179">$person</span>->grants,
                  <span style="color: #FF6179">$grantSort</span>);</span>
  ...
  <section id="result">
    <div class="result-wrap text-black pt-5 pb-5 position-relative rounded-bottom-4">
      <div class="container result">
        ...
        -->
        <div
          class="align-items-center col-12 ps-2 result-logo-wrap col-sm-11 col-xl-12 d-flex gap-3 mx-auto mt-4 rounded-5">
        ...
        <div class="row justify-content-between mx-auto gx-4">
          <div
            class="col-xxl-4 col-xl-6 col-12 col-sm-11 d-flex justify-content-between mx-auto mx-xl-0 align-items-center result-colors text-center gap-3 mt-4">
          ...
          <div
            class="col-xxl-4 col-xl-6 col-12 heads-wrap d-flex px-2 justify-content-xxl-center justify-content-evenly align-items-center gap-xxl-5 gap-5 mt-4">
        ...
        <div class="row screenshot-row justify-content-between d-none d-lg-flex">
          <div class="col-5 col-xxl-3 align-items-center d-flex pb-3 order-0">
            <div
              class="screenshot-item z-3 filter fs-6 ms-5 me-auto mx-xxl-auto p-3 position-relative mb-2 mb-xl-5 mb-xxl-auto"
              data-aos="fade-right" data-aos-delay="50">
              <svg width="294" height="85" viewBox="0 0 294 85" fill="none" xmlns="http://www.w3.org/2000/svg"
                class="item-path">
                <path d="M293.5 25.2271C293.5 25.2271 209 -9.27318 121.5 3.22754C34 15.7283 11 59.2259 4 79.2272"
                  stroke="url(#paint0_linear_98_5)" stroke-dasharray="3 3" />
                <circle cx="4" cy="80.7271" r="4" transform="rotate(-180 4 80.7271)" fill="#F8B81D" />
                <defs>
                  <linearGradient id="paint0_linear_98_5" x1="25.8579" y1="26.2217" x2="204.5" y2="26.2217"
                    gradientUnits="userSpaceOnUse">
              ...
              <svg width="8" height="254" viewBox="0 0 8 254" fill="none" xmlns="http://www.w3.org/2000/svg"
                class="item-path med">
                <circle cx="4.00001" cy="4" r="4" transform="rotate(90 4.00001 4)" fill="#F8B81D" />
                <path d="M4.49996 253.5C4.49996 253.5 4.50006 19.3502 4.50007 3.5" stroke="url(#paint0_linear_102_9)"
                  stroke-dasharray="3 3" />
                <defs>
                  <linearGradient id="paint0_linear_102_9" x1="4.60184" y1="-39.9324" x2="4.60179" y2="217.477"
                    gradientUnits="userSpaceOnUse">
                    <stop stop-color="#F8B81D" />
                    <stop offset="1" stop-color="#F8B81D" stop-opacity="0.3" />
                  </linearGradient>
              ...
              <p class="z-2 mb-0 inter-light text-slate-grey position-relative">by department or campus to narrow your
                results</p>
            </div>
          </div>
          <div class="col-10 col-xxl-6 mx-auto order-2 order-xxl-1 mt-2">
            <div class="img-wrap position-relative">
              <img src="/lincus-assets/assets/lincus-map.png" alt="Screenshot of search page"
                class="img-fluid screenshot mt-xxl-0 radius">
            </div>
          </div>
          <div class="col-5 col-xxl-3 order-1 order-xxl-2">
            <div
              class="screenshot-item search fs-6 me-5 ms-auto mx-xxl-auto mb-2 mb-xl-5 mb-xxl-auto p-3 w-75 position-relative"
              data-aos="fade-left" data-aos-delay="50">
              <svg width="177" height="8" viewBox="0 0 177 8" fill="none" xmlns="http://www.w3.org/2000/svg"
                class="item-path">
                <circle cx="173" cy="4" r="4" transform="rotate(-180 173 4)" fill="#F8B81D" />
                <path d="M0 4.0034C0 4.0034 162.5 4.00046 173.5 4.00047" stroke="url(#paint0_linear_99_6)"
                  stroke-dasharray="3 3" />
                <defs>
                  <linearGradient id="paint0_linear_99_6" x1="203.642" y1="-1.49805" x2="24.9998" y2="-1.49806"
                    gradientUnits="userSpaceOnUse">
                    <stop stop-color="#F8B81D" />
                    <stop offset="1" stop-color="#F8B81D" stop-opacity="0.3" />
                  </linearGradient>
              ...
              <svg width="205" height="181" viewBox="0 0 205 181" fill="none" xmlns="http://www.w3.org/2000/svg"
                class="item-path med">
                <path
                  d="M42.3731 168.914C42.3731 168.914 98.5535 171.414 132.554 128.414C166.554 85.4145 159.418 26.0727 157.184 4.99985"
                  stroke="url(#paint0_linear_145_8)" stroke-dasharray="3 3" />
                <circle cx="157.327" cy="5.32708" r="4" transform="rotate(64.6603 157.327 5.32708)" fill="#F8B81D" />
                <defs>
                  <linearGradient id="paint0_linear_145_8" x1="160.374" y1="5.4138" x2="64.874" y2="165.914"
                    gradientUnits="userSpaceOnUse">
                    <stop stop-color="#F8B81D" />
                    <stop offset="1" stop-color="#F8B81D" stop-opacity="0.3" />
                  </linearGradient>
        ...
        <div class="screenshot-row-sm mx-auto mt-5 d-flex d-lg-none flex-column justify-content-center">
          <div class="row align-items-start">
            <div
              class="col-12 col-md-5 d-flex flex-column justify-content-center justify-content-md-start mb-5 filter-sm">
              <div class="screenshot-item sm mb-3 w-80 filter fs-6 m-auto p-3 position-relative w-90"
                data-aos="fade-right" data-aos-delay="50">
                <span class="z-2 inter-med text-slate-grey position-relative">Filter</span>
                <p class="z-2 mb-0 inter-light text-slate-grey position-relative">by department or campus to narrow your
                  results</p>
              </div>
              <img src="/lincus-assets/assets/lincus-filters.png" alt="Lincus Filtering"
                class="h-500-px mx-auto d-block d-md-none radius" data-aos="fade-right" data-aos-delay="200">
            </div>
            <div class="col-12 col-md-7 d-flex flex-column justify-content-center justify-content-md-start connect-sm">
              <div class="screenshot-item sm mb-3 w-80 connect fs-6 m-auto p-3 position-relative w-90"
                data-aos="fade-left" data-aos-delay="50">
                <span class="z-2 inter-med text-slate-grey position-relative">Connect</span>
                <p class="z-2 mb-0 inter-light text-slate-grey position-relative">with individuals based on their
                  expertise</p>
              </div>
              <img src="/lincus-assets/assets/lincus-connect.png" alt="Lincus Connections"
                class=" w-90 mx-auto d-block d-md-none radius" data-aos="fade-left" data-aos-delay="200">
            </div>
          </div>
          <div class="row align-items-start d-none d-md-flex">
            <div class="col-5 d-flex" data-aos="fade-right" data-aos-delay="200">
              <img src="/lincus-assets/assets/lincus-filters.png" alt="Lincus Filtering"
                class="h-500-px mx-auto radius">
            </div>
            <div class="col-7 d-flex" data-aos="fade-left" data-aos-delay="200">
              <img src="/lincus-assets/assets/lincus-connect-1.png" alt="Lincus Connections"
                class="h-500-px mx-auto radius">
            </div>
          </div>
        ...
        <div class="row mt-5 d-none d-lg-flex">
          ...
          <div class="col-3 d-flex justify-content-end ms-5">
            <div class="screenshot-item connect fs-6 m-auto p-3 position-relative" data-aos="fade-up"
              data-aos-delay="300">
              <svg width="181" height="205" viewBox="0 0 181 205" fill="none" xmlns="http://www.w3.org/2000/svg"
                class="item-path">
                <path
                  d="M11.1205 42.3728C11.1205 42.3728 8.62026 98.5532 51.6201 132.554C94.6198 166.554 153.962 159.417 175.034 157.184"
                  stroke="url(#paint0_linear_101_8)" stroke-dasharray="3 3" />
                <circle cx="174.948" cy="157.38" r="4" transform="rotate(64.6603 174.948 157.38)" fill="#F8B81D" />
                <defs>
                  <linearGradient id="paint0_linear_101_8" x1="174.62" y1="160.374" x2="14.1205" y2="64.8738"
                    gradientUnits="userSpaceOnUse">
                    <stop stop-color="#F8B81D" />
                    <stop offset="1" stop-color="#F8B81D" stop-opacity="0.3" />
                  </linearGradient>
        ...
        <div class="row summarize-row align-items-center">
          <div class="col-lg-3 col-12 w-fit mx-auto">
            <div class="screenshot-item summarize fs-6 m-auto p-3 position-relative" data-aos="fade-up"
              data-aos-delay="400">
              <svg width="177" height="8" viewBox="0 0 177 8" fill="none" xmlns="http://www.w3.org/2000/svg"
                class="item-path d-none d-lg-block">
                <circle cx="4" cy="4" r="4" fill="#F8B81D" />
                <path d="M177 3.99612C177 3.99612 14.5001 3.99905 3.5 3.99905" stroke="url(#paint0_linear_102_9)"
                  stroke-dasharray="3 3" />
                <defs>
                  <linearGradient id="paint0_linear_102_9" x1="-26.6421" y1="9.49755" x2="152" y2="9.49759"
                    gradientUnits="userSpaceOnUse">
                    <stop stop-color="#F8B81D" />
                    <stop offset="1" stop-color="#F8B81D" stop-opacity="0.3" />
                  </linearGradient>
      ...
      <div class="testimonies-wrap">
        <button style="margin:0px 20px;" id="testimonials-control-btn" class="testimonials-control-btn"
          aria-label="Pause testimonials carousel" aria-pressed="false" title="Press to pause/play">
  ...
  <section id="looking-ahead">
    <div class="container looking-ahead pt-5 mt-4" style="min-height: 1000px">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <span class="mb-b fs-2 inter-light">
            And for <a target="_blank" href="https://www.linkedin.com/in/magdalena-danielewicz"><span
                class="inter-med yellow-shadow">Maggie?</span></a>
          </span>
      ...
      <div class="row g-4 align-items-stretch maggie-row">
        <div class="col-lg-6">
          <div
            class="bg-off-white radius quote-wrap px-5 h-100 position-relative d-flex flex-column justify-content-center position-relative">
            ...
            <p class="inter-light" style="font-style:italic;font-size:18px;">
              i3 gave me the tools to transform my knowledge from 4 years at UConn and give back to the school that
              taught me so much. As a student, <strong>that experience is incredibly rewarding and unique</strong>.
              Being able to use my computing skills to rebuild Lincus — something that will help both faculty expertise
        ...
        <div class="col-lg-6">
          <figure class="position-relative h-100 m-0">
            <img src="/lincus-assets/assets/mags-engineering.png" alt="Maggie working on a project"
              class="img-fluid w-100 h-100 object-fit-cover rounded-1" style="min-height:340px;">
