...
.bn-wrap::after { content: ""; display: block; clear: both; }
.bn-wrap .bn-figure--end { float: right; width: min(48%, 520px); margin: 0 0 1rem 2rem; }
.bn-wrap > span + span { display: block; margin-top: 1rem; }
...
<div class="bn pt-5">
  ...
  <div class="d-flex flex-column gap-3 line-height-1_8">
              ...
              <strong><span data-contrast="none">The Tuchyn Story </span></strong>
              ...
              <div class="bn-wrap">
                <figure class="bn-figure bn-figure--end m-0">
