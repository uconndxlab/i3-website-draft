                ...
                <div class="container">
                    ...
                    <div class="row align-items-top g-5" data-aos-delay="200">
                        ...
                        <div class="col-lg-6" data-aos="fade-right">
                            <form method="POST" action="{{ route('contact.store') }}" class="contact-form text-light"
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-2 col-md-6">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-2">
                                <a href="{{ route('team') }}"
                                    class="text-light opacity-75 text-decoration-none hover-opacity-100">People</a>
                            </li>
                            <li class="mb-2">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="mb-3">
                            <div class="d-flex align-items-start gap-2 mb-2">
                                ...
                                <div>
                                    <div class="text-light">Whetten 200</div>
            ...
            <section class="footer footer-index py-4 text-light">
                ...
                <div class="container footer-info d-flex justify-space-between flex-wrap justify-content-center pt-4">
                    ...
                    <a class="footer-link small" href="https://uconn.edu/disclaimers-privacy-copyright/"
                        ...
                        Copyright</a>
                    <a class="footer-link small" href="https://accessibility.uconn.edu/"
                        target="_blank">Accessibility</a>
                    <p class="footer-link" style="font-size:14px">Built with ❤️ and Laravel by the <acronym
                            style="cursor: help"title="Victoria, BK, Natalie, Shium, and Joel">i3 team</acronym></p>
                </div>
            </section>
        </footer>
