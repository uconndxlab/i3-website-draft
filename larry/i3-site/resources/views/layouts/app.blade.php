...
<body>
    ...
    <div class="container">
      <h2 class="mb-4 d-inline-block pb-3" data-aos="fade-down"><span class="border-bottom border-2 pb-3 border-primary">CONTACT</span> US</h2>
          ...
          <div class="col-lg-6" data-aos="fade-left">
            <div class="maps">
              ...
              <iframe title="Google Map of our Location in the Rowe Building at UConn"
                      ...
                      width="80%" height="80%" frameborder="0" style="border:0;border-radius: 20px" allowfullscreen="" aria-hidden="false"
                      tabindex="0"></iframe>
            </div>
