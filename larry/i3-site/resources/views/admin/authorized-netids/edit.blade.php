        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Edit Authorized NetID</h5>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.authorized-netids.update', $authorizedNetid) }}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="netid" 
                                           name="netid" 
                                           value="{{ old('netid', $authorizedNetid->netid) }}" 
                                           required>
                                    @error('netid')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="name" 
                                           name="name" 
                                           value="{{ old('name', $authorizedNetid->name) }}">
                                    @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" 
                                           ...
                                           id="email" 
                                           name="email" 
                                           value="{{ old('email', $authorizedNetid->email) }}">
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('is_active') is-invalid @enderror" 
                                            id="is_active" 
                                            name="is_active">
                                        <option value="1" {{ old('is_active', $authorizedNetid->is_active) ? 'selected' : '' }}>Active</option>
                                        <option value="0" {{ old('is_active', $authorizedNetid->is_active) ? '' : 'selected' }}>Inactive</option>
                                    </select>
                                    @error('is_active')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save"></i> Update NetID
                            </button>
                        </div>
                    </form>
                </div>
